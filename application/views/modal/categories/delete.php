...
$this->load->view('components/modal/header', array(
    ...
    'modal_subtitle' => 'This action permanently removes the selected category.',
    'modal_icon' => 'bi-trash3'
));
?>

<div class="modal-body">
    <p>Category: <strong><?php echo html_escape($category->category_name); ?></strong></p>

    <?php if (!empty($delete_error)): ?>
        <div class="alert alert-warning mb-0"><?php echo html_escape($delete_error); ?></div>
    <?php else: ?>
        <div class="alert alert-danger mb-0">Are you sure you want to delete this category?</div>
    <?php endif; ?>
</div>

...
$this->load->view('components/modal/header', array(
    ...
    'modal_subtitle' => 'Manage the user profile, account access, role, and status.',
...
<div class="modal-body">
    ...
    <div class="row g-3">
        ...
        <div class="col-12 col-md-6">
            <label for="password" class="form-label">Password<?php echo isset($user) && $user ? ' (leave blank to keep current password)' : ''; ?></label>

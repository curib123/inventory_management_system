...
<?php echo form_open(current_url(), array('data-modal-form' => '1')); ?>
    <p>
        ...
        <input type="text" id="product_name" name="product_name" required maxlength="150" value="<?php echo html_escape(set_value('product_name', isset($product) && $product ? $product->product_name : '')); ?>">
    </p>
    <p>
        <label for="product_code">Product Code</label><br>
        <input type="text" id="product_code" name="product_code" required maxlength="50" value="<?php echo html_escape(set_value('product_code', isset($product) && $product ? $product->product_code : '')); ?>">
    </p>
    <p>
    ...
    <p>
        ...
        <input type="text" id="unit" name="unit" maxlength="50" value="<?php echo html_escape(set_value('unit', isset($product) && $product ? $product->unit : '')); ?>">
    </p>
    <p>
        <label for="cost_price">Cost Price</label><br>
        <input type="number" id="cost_price" name="cost_price" min="0" step="0.01" required value="<?php echo html_escape(set_value('cost_price', isset($product) && $product ? $product->cost_price : '0.00')); ?>">
    </p>
    <p>
        <label for="selling_price">Selling Price</label><br>
        <input type="number" id="selling_price" name="selling_price" min="0" step="0.01" required value="<?php echo html_escape(set_value('selling_price', isset($product) && $product ? $product->selling_price : '0.00')); ?>">
    </p>
    <p>
        <label for="reorder_level">Reorder Level</label><br>
        <input type="number" id="reorder_level" name="reorder_level" min="0" step="1" required value="<?php echo html_escape(set_value('reorder_level', isset($product) && $product ? $product->reorder_level : '0')); ?>">
    </p>
    <p>

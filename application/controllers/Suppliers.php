...
class Suppliers extends CI_Controller {
    ...
    public function datatable() {
        ...
        $can_edit = $this->authorization_service->has_permission($current_user_id, 'suppliers.edit');
        $can_delete = $this->authorization_service->has_permission($current_user_id, 'suppliers.delete');
